...
use query::{
    ...
    get_path, get_paths_for_owner, get_paths_for_owner_and_token, is_contract, primary_alias, list_info_by_alias
};
...
pub mod entry {
    ...
    pub fn query(deps: Deps, env: Env, msg: QueryMsg) -> StdResult<Binary> {
        ...
        match msg {
            ...
            QueryMsg::ListInfoByAlias { aliases } => to_binary(&list_info_by_alias(tract, deps, aliases)?),
